...
export const GRAMMAR_ACTIVITY: LessonActivityId = 'grammar'
...
/** Actividades que varían al azar por nivel (gramática, quiz y stop siempre fijas). */
 ...
 * Actividades del nivel: subconjunto aleatorio (cambia al avanzar de nivel) + gramática, quiz y stop siempre.
